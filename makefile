...
#
#	Be sure that you there are NO copies of scp.c, 
...
#
#	Be sure that you DO have copies of scp.c, sim_sock.c,
...
#
BIN = 
SIM = scp.c sim_console.c sim_fio.c sim_sock.c sim_timer.c sim_tmxr.c 
...
ibm1130  = ${ibm1130D}ibm1130_sys.c	${ibm1130D}ibm1130_cpu.c \
	   ...
	   ${ibm1130D}ibm1130_sca.c     ${ibm1130D}ibm1130_plot.c \
